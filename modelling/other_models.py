...
# predictions = all_predictions.reshape((4700840, 26))
#
# subset_size = int(0.01 * len(predictions))
# subset_indices = np.random.choice(range(len(predictions)), subset_size, replace=False)
# sub_predictions = predictions[subset_indices]
#
